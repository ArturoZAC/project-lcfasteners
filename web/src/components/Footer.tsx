...
import { Container } from "../ui/Container";
import { IconMailSpark, IconPhone } from "@tabler/icons-react";
import logoFooter from "../assets/footerlogo.png";
import logoFooterPe from "../assets/logosPeru.webp";
// import { Link } from "react-router-dom";
  ...
  return (
    <footer className="w-full bg-navy-hover text-gray-300">
      <Container className="py-12">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
          {/* Columna 1 - Company Info */}
          <div>
            <div className="flex items-center gap-2 mb-4 justify-start">
              <img src={logoFooter} alt="LC Fasteners" className="w-32" />
            </div>
            <h4 className="text-white font-semibold mb-2">
              LC Fasteners & Coatings Branch LATAM S.A.C.
            </h4>
            <p className="text-sm text-gray-400 leading-relaxed">
              Ingeniería aplicada a sujetadores industriales.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-2">
                <IconPhone className="w-5 h-5 shrink-0" />
                <div>
                  <p className="text-gray-400 text-xs mb-1">Teléfono ventas:</p>
                  <a href="tel:+51957194775" className="hover:text-white transition">
                    +51 957 194 775
                  </a>
                </div>
              </li>
              <li className="flex items-center gap-2">
                <IconMailSpark className="w-5 h-5 shrink-0" />
                <div>
                  <p className="text-gray-400 text-xs mb-1">Correo técnico:</p>
              ...
              <li className="flex items-center gap-2">
                <IconMailSpark className="w-5 h-5 shrink-0" />
                <div>
                  <p className="text-gray-400 text-xs mb-1">Correo institucional:</p>
                  <a href="mailto:contacto@lcfclatam.com" className="hover:text-white transition">
                    contacto@lcfclatam.com
                  </a>
                </div>
              </li>
            </ul>
