  ...
  return (
    <Banner backgroundColor="bg-navy-hover" className="py-16 md:py-20">
      <div className="max-w-4xl mx-auto">
        {/* 5️⃣ Título - Sin cortes silábicos */}
        ...
        {/* Texto introductorio - Sin cortes silábicos */}
        ...
        {/* 5️⃣ Lista de cumplimiento - Sin cortes silábicos, bullets legibles */}
        ...
        {/* Texto de cierre - Sin cortes silábicos */}
